...
git clone https://github.com/afnan-altaf/humanizer.git ~/.claude/skills/humanizer
```
...
git clone https://github.com/afnan-altaf/humanizer.git ~/.config/opencode/skills/humanizer
```
